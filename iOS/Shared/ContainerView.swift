...
struct ContentView: View {
    ...
    @ViewBuilder
    private var channel0FreqView: some View {
        VStack {
    ...
    @ViewBuilder
    private var channel0PitchControls: some View {
        VStack {
    ...
    @ViewBuilder
    private var channel0RollView: some View {
        VStack {
    ...
    @ViewBuilder
    private var channel0View: some View {
        VStack {
            HStack {
                VStack {
                    self.channel0RollView
                    self.channel0FreqView
                }
                VStack {
                    Text("A").font(.caption)
                    ZStack {
    ...
    @ViewBuilder
    private var channel1FreqView: some View {
        VStack {
            Text("HP").font(.caption)
            ZStack {
    ...
    @ViewBuilder
    private var channel1PitchControls: some View {
        VStack {
            Text("Pitch").font(.caption)
            HStack {
                Button("-1", action: {
    ...
    @ViewBuilder
    private var channel1RollView: some View {
        VStack {
            Text("ROLL").font(.caption)
            Button("2", action: {
                if channel1Roll == 2 {
    ...
    @ViewBuilder
    private var channel1View: some View {
        VStack {
            HStack {
                ZStack {
                ...
                VStack {
                    self.channel1RollView
                    self.channel1FreqView
                }
            }
            self.channel1PitchControls
